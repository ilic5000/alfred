package pmf.ni.ac.rs.alfredhost;
...
/**
 * Created by Nenad Ilic on 29.12.2016.
 * Original class by Goran Rakić,
 * // JFreesteel native messaging project
 */

public class WebHostExtensionApp {   private final static Logger logger = LoggerFactory.getLogger(WebHostExtensionApp.class);
    ...
    private void sendTerminals() {sendMessage(JSONArray.toJSONString(terminalNames));
    }
    ...
    private void inserted(final EidCard card, String terminalName) {
        ...
        try {
            ...
            logger.error(info.toJSON().toString());
